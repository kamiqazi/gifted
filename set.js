...
global.caption = "*✅*"; // Input Yours custom...(Maintain font for Flow)
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923112345043", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "⏤͟͟͞➣⃟⃟🍒𝚫𝐘𝚫𝚭~ ⃟⃟⃟⃟❤️", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "Made By", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "ɳoɓꀤʈɑ 👑🖤🎧", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "⏤͟͟͞➣⃟⃟🍒𝚫𝐘𝚫𝚭~ ⃟⃟⃟⃟❤️", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://files.catbox.moe/g18o7b.jpeg", // You can Replace with yours...
